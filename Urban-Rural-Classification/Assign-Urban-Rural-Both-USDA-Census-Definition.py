...
# This creates a new file that I titled "Midwest-Sars-Cov-2-ASSIGNED-Metadata"
usda_merged_df.to_csv('Midwest-Sars-Cov-2-ASSIGNED-Metadata.csv')
...
file_path = 'Combined-Assigned-Metadata.csv'
df = pandas.read_csv(file_path)
